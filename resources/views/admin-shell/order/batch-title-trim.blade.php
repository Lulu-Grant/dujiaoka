...
@section('content')
    ...
    <div class="admin-shell-card">
        <div class="admin-shell-card__header">
            <div>
                <h2 class="admin-shell-card__title">批量清理订单标题空格</h2>
                <p class="admin-shell-card__description">输入订单 ID 后，可以先预览命中的订单，再统一清理当前订单标题首尾空格。</p>
            </div>
        ...
        <form method="post" action="{{ $formAction }}" class="admin-shell-form">
            ...
            <div class="admin-shell-form__grid">
                <label class="admin-shell-form__field admin-shell-form__field--full">
                    ...
                    <span class="admin-shell-form__hint">支持换行、英文逗号或中文逗号分隔。系统会自动去重并忽略无效 ID，只清理命中订单标题的首尾空格。</span>
                    @error('ids_text')
    ...
    <div class="admin-shell-card">
        <div class="admin-shell-card__header">
            <div>
                ...
                <p class="admin-shell-card__description">预览当前输入 ID 命中的订单，确认后再统一清理标题空格。</p>
            </div>
        </div>
