        ...
        <div class="panel-body">
            <div class="detail-grid">
                ...
                <div class="detail-item">
                    ...
                    <div class="detail-value">仅更新订单类型，不改状态、支付、履约和通知链</div>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="panel-body">
            <form method="post" action="{{ $formAction }}" class="form-stack">
                ...
                <div class="notice info" style="margin-bottom: 18px;">
                    这张页只做一件事：批量设置订单类型。先输入一串订单 ID 预览匹配结果，再统一切换到目标类型。
                </div>
                ...
                <div class="filters" style="align-items: stretch;">
                    ...
                    <label>
                        <span>目标类型</span>
                        <small style="display:block; margin-top:6px; color:#66756b;">这一步只会更新订单类型字段，不会触发支付完成、发货或通知。</small>
    ...
    @if(!empty($context['missingIds']))
        <section class="panel">
            <div class="panel-body">
                ...
                <p class="page-description">这些 ID 会被忽略，不影响已匹配订单的批量类型更新。</p>
    ...
    @if(!empty($context['items']))
        <section class="panel">
            <div class="panel-body">
                ...
                <h2 class="page-title" style="font-size: 24px; margin-top: 6px;">这次会更新这些订单的类型</h2>
                <p class="page-description">先确认订单号、标题、当前状态和当前类型，再执行批量更新，避免粘错 ID。</p>
                ...
                <div class="detail-grid" style="margin-top: 20px;">
                    @foreach($context['items'] as $item)
                        <div class="detail-item">
                            ...
                            <div class="meta" style="margin-top: 6px;">类型：{{ $item['type'] }}</div>
