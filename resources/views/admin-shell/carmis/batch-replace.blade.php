        ...
        <div class="panel-body">
            <div class="detail-grid">
                ...
                <div class="detail-item">
                    ...
                    <div class="detail-value">仅替换卡密内容文本片段，不改销售状态、循环使用和商品归属</div>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="panel-body">
            <form method="post" action="{{ $formAction }}" class="form-stack">
                ...
                <div class="notice info" style="margin-bottom: 18px;">
                    这张页只做一件事：批量替换卡密内容中的指定文本片段。先输入一串卡密 ID 预览匹配结果，再统一整理文本。
                </div>
                ...
                <div class="filters" style="align-items: stretch;">
                    ...
                    <label>
                        <span>查找片段</span>
                        <input type="text" name="search_text" value="{{ old('search_text', $defaults['search_text']) }}" placeholder="例如：OLD">
                        <small style="display:block; margin-top:6px; color:#66756b;">只替换完全命中的文本片段；不能为空。</small>
                    </label>
                    <label>
                        <span>替换为</span>
                        <input type="text" name="replace_text" value="{{ old('replace_text', $defaults['replace_text']) }}" placeholder="例如：NEW">
                        <small style="display:block; margin-top:6px; color:#66756b;">留空时会删除命中的片段，其他字段不会被修改。</small>
                    </label>
                </div>
    ...
    @if(!empty($context['missingIds']))
        <section class="panel">
            <div class="panel-body">
                ...
                <p class="page-description">这些 ID 会被忽略，不影响已匹配卡密的内容片段替换。</p>
    ...
    @if(!empty($context['items']))
        <section class="panel">
            <div class="panel-body">
                ...
                <h2 class="page-title" style="font-size: 24px; margin-top: 6px;">这次会替换这些卡密的内容片段</h2>
                <p class="page-description">先确认商品归属、销售状态和当前卡密内容，再执行批量替换。</p>
