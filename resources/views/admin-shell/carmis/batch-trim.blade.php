        ...
        <div class="panel-body">
            <div class="detail-grid">
                ...
                <div class="detail-item">
                    ...
                    <div class="detail-value">仅清理卡密内容首尾空格，不改销售状态、循环使用和商品归属</div>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="panel-body">
            <form method="post" action="{{ $formAction }}" class="form-stack">
                ...
                <div class="notice info" style="margin-bottom: 18px;">
                    这张页只做一件事：批量清理卡密内容首尾空格。先输入一串卡密 ID 预览匹配结果，再统一清理文本格式。
                </div>

                <div class="filters" style="align-items: stretch;">
                    <label style="grid-column: 1 / -1;">
                        <span>卡密 ID 列表</span>
                        <small style="display:block; margin-top:6px; color:#66756b;">支持换行、逗号或空格分隔。保存时会自动去重，只清理命中卡密内容首尾空格。</small>
    ...
    @if(!empty($context['missingIds']))
        <section class="panel">
            <div class="panel-body">
                ...
                <p class="page-description">这些 ID 会被忽略，不影响已匹配卡密的内容空格清理。</p>
    ...
    @if(!empty($context['items']))
        <section class="panel">
            <div class="panel-body">
                ...
                <h2 class="page-title" style="font-size: 24px; margin-top: 6px;">这次会清理这些卡密的内容空格</h2>
