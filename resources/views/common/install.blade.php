...
<div class="container">
    <h1>
        <img src="/assets/avatar/images/dujiaoka-xigua.png" alt="独角数卡西瓜版" style="width: 180px; max-width: 100%; height: auto; display: inline-block;">
    </h1>
    <h2>独角数卡西瓜版 「{{ config('dujiaoka.dujiaoka_version') }}」</h2>
    <div>
        ...
        <form method="post">
            ...
            <div class="form-group">
                <div class="form-field">
                    <label>网站名称</label>
                    <input type="title" value="独角数卡西瓜版" name="title" required="">
                </div>
