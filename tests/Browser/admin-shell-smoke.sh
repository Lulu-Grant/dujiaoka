...
assert_page "/admin" "后台总览 - 独角数卡西瓜版" "今日支付成功率"
assert_page "/admin/v2/dashboard" "后台总览 - 独角数卡西瓜版" "今日完成订单"
assert_page "/admin/auth/setting" "账号设置 - 独角数卡西瓜版" "保存账号设置"
...
assert_page "/admin/v2/goods/batch-status" "批量启停商品 - 后台壳样板" "目标状态"
...
assert_page "/admin/v2/coupon/batch-status" "批量启停优惠码 - 后台壳样板" "目标状态"
assert_page "/admin/v2/coupon/batch-use" "批量设置优惠码使用状态 - 后台壳样板" "目标使用状态"
assert_page "/admin/v2/coupon/batch-discount" "批量设置优惠码折扣 - 后台壳样板" "目标折扣金额"
...
assert_page "/admin/v2/pay/batch-status" "批量启停支付通道 - 后台壳样板" "目标状态"
assert_page "/admin/v2/pay/batch-client" "批量切换支付场景 - 后台壳样板" "目标支付场景"
...
assert_page "/admin/v2/carmis/batch-loop" "批量设置循环使用 - 后台壳样板" "执行批量循环设置"
...
assert_page "/admin/v2/order/batch-status" "批量更新订单状态 - 后台壳样板" "目标状态"
