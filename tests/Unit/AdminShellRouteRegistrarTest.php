...
class AdminShellRouteRegistrarTest extends TestCase
{
    public function test_register_adds_index_and_show_routes_for_registered_resources(): void
    {
        ...
        $this->assertRouteExists($routes, 'v2/order/batch-title-suffix', 'GET', 'admin-shell.order.batch-title-suffix');
        ...
        $this->assertRouteExists($routes, 'v2/pay/batch-name-trim', 'GET', 'admin-shell.pay.batch-name-trim');
        $this->assertRouteExists($routes, 'v2/pay/batch-name-trim', 'POST', 'admin-shell.pay.batch-name-trim.update');
        $this->assertRouteExists($routes, 'v2/pay/batch-name-collapse-spaces', 'GET', 'admin-shell.pay.batch-name-collapse-spaces');
        $this->assertRouteExists($routes, 'v2/pay/batch-name-collapse-spaces', 'POST', 'admin-shell.pay.batch-name-collapse-spaces.update');
        ...
        $this->assertRouteExists($routes, 'v2/coupon/batch-code-replace', 'GET', 'admin-shell.coupon.batch-code-replace');
        $this->assertRouteExists($routes, 'v2/coupon/batch-code-replace', 'POST', 'admin-shell.coupon.batch-code-replace.update');
        ...
        $this->assertRouteExists($routes, 'v2/coupon/batch-code-collapse-spaces', 'GET', 'admin-shell.coupon.batch-code-collapse-spaces');
        $this->assertRouteExists($routes, 'v2/coupon/batch-code-collapse-spaces', 'POST', 'admin-shell.coupon.batch-code-collapse-spaces.update');
        ...
        $this->assertRouteExists($routes, 'v2/carmis/batch-replace', 'GET', 'admin-shell.carmis.batch-replace');
        $this->assertRouteExists($routes, 'v2/carmis/batch-replace', 'POST', 'admin-shell.carmis.batch-replace.update');
        $this->assertRouteExists($routes, 'v2/carmis/batch-suffix', 'GET', 'admin-shell.carmis.batch-suffix');
