...
class CouponActionServiceTest extends TestCase
{
    ...
    public function test_batch_code_prefix_defaults_start_empty_for_safe_review(): void
    {
        $defaults = app(CouponActionService::class)->batchCodePrefixDefaults([1, 2]);
    ...
    public function test_batch_code_replace_defaults_start_empty_for_safe_review(): void
    {
        $defaults = app(CouponActionService::class)->batchCodeReplaceDefaults([1, 2]);
    ...
    public function test_batch_code_collapse_spaces_defaults_only_require_ids_for_safe_review(): void
    {
        $defaults = app(CouponActionService::class)->batchCodeCollapseSpacesDefaults([1, 2]);
