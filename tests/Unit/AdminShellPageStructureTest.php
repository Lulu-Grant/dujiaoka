...
class AdminShellPageStructureTest extends TestCase
{
    ...
    public function test_pay_page_service_builds_table_and_detail_items()
    {
        ...
        $this->assertSame('批量切换方式', $header['actions'][3]['label']);
        $this->assertSame('批量设置名称', $header['actions'][4]['label']);
        ...
        $this->assertSame('批量压缩名称空格', $header['actions'][9]['label']);
        $this->assertSame('新建支付通道', $header['actions'][10]['label']);
        $this->assertSame('导出结构化 CSV', $header['actions'][11]['label']);
    ...
    public function test_order_page_service_builds_table_and_detail_items()
    {
        ...
        $this->assertSame('批量设置订单类型', $header['actions'][2]['label']);
        ...
        $this->assertSame('批量清理标题空格', $header['actions'][7]['label']);
        $this->assertSame('批量压缩标题空格', $header['actions'][8]['label']);
        $this->assertSame('批量重置查询密码', $header['actions'][9]['label']);
    ...
    public function test_coupon_page_service_builds_table_and_detail_items()
    {
        ...
        $this->assertSame('批量设置使用状态', $header['actions'][4]['label']);
        $this->assertSame('批量设置折扣', $header['actions'][5]['label']);
        $this->assertSame('批量设置可用次数', $header['actions'][6]['label']);
        $this->assertSame('批量重生成优惠码', $header['actions'][7]['label']);
        $this->assertSame('批量添加优惠码前缀', $header['actions'][8]['label']);
    ...
    public function test_carmis_page_service_builds_table_and_detail_items()
    {
        ...
        $this->assertSame('导出 CSV', $header['actions'][6]['label']);
        $this->assertSame('导出当前筛选', $header['actions'][7]['label']);
        $this->assertStringContainsString('?scope=trashed', $showHeader['actions'][0]['href']);
