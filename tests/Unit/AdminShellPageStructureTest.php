...
class AdminShellPageStructureTest extends TestCase
{
    ...
    public function test_goods_page_service_builds_table_and_detail_items()
    {
        ...
        $this->assertSame('导出文本', $header['actions'][5]['label']);
        $this->assertSame('导出 CSV', $header['actions'][6]['label']);
        $this->assertStringContainsString('export=text', $header['actions'][5]['href']);
        $this->assertStringContainsString('export=csv', $header['actions'][6]['href']);
    ...
    public function test_pay_page_service_builds_table_and_detail_items()
    {
        ...
        $this->assertSame('新建支付通道', $header['actions'][5]['label']);
        $this->assertSame('导出结构化 CSV', $header['actions'][6]['label']);
        $this->assertSame('导出当前筛选', $header['actions'][7]['label']);
        $this->assertStringContainsString('export=csv', $header['actions'][6]['href']);
        $this->assertStringContainsString('export=txt', $header['actions'][7]['href']);
    ...
    public function test_order_page_service_builds_table_and_detail_items()
    {
        ...
        $this->assertSame('批量重置查询密码', $header['actions'][4]['label']);
