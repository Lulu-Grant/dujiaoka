...
class GoodsActionServiceTest extends TestCase
{
    ...
    public function test_batch_keywords_collapse_spaces_defaults_only_require_ids_for_safe_review(): void
    {
        $defaults = app(GoodsActionService::class)->batchKeywordsCollapseSpacesDefaults([96101, 96102]);
