...
class AdminShellOrderPageService extends AbstractAdminShellPageService
{
    ...
    public function buildHeaderWithFilters(LengthAwarePaginator $orders, array $filters): array
    {
        ...
        $header['actions'][] = [
            'label' => '批量设置附加信息',
            'href' => admin_url('v2/order/batch-info'),
            'variant' => 'secondary',
        ];
        $header['actions'][] = [
            'label' => '批量设置订单标题',
            'href' => admin_url('v2/order/batch-title'),
            'variant' => 'secondary',
        ];
        $header['actions'][] = [
            'label' => '批量添加标题前缀',
        ...
        $header['actions'][] = [
            'label' => '批量添加标题后缀',
            'href' => admin_url('v2/order/batch-title-suffix'),
            'variant' => 'secondary',
        ];
        $header['actions'][] = [
            'label' => '批量清理标题空格',
            'href' => admin_url('v2/order/batch-title-trim'),
            'variant' => 'secondary',
        ];
        $header['actions'][] = [
            'label' => '批量压缩标题空格',
            'href' => admin_url('v2/order/batch-title-collapse-spaces'),
            'variant' => 'secondary',
        ];
        $header['actions'][] = [
            'label' => '批量重置查询密码',
