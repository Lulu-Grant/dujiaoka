...
class AdminShellCouponPageService extends AbstractAdminShellPageService
{
    ...
    public function buildHeader(LengthAwarePaginator $coupons, array $filters): array
    {
        ...
        $header['actions'][] = [
            'label' => '批量添加优惠码前缀',
            'href' => admin_url('v2/coupon/batch-code-prefix'),
            'variant' => 'secondary',
        ];
        $header['actions'][] = [
            'label' => '批量添加优惠码后缀',
            'href' => admin_url('v2/coupon/batch-code-suffix'),
            'variant' => 'secondary',
        ];
        $header['actions'][] = [
            'label' => '批量替换优惠码片段',
            'href' => admin_url('v2/coupon/batch-code-replace'),
            'variant' => 'secondary',
        ];
        $header['actions'][] = [
            'label' => '批量清理优惠码空格',
            'href' => admin_url('v2/coupon/batch-code-trim'),
            'variant' => 'secondary',
        ];
        $header['actions'][] = [
            'label' => '批量压缩优惠码空格',
            'href' => admin_url('v2/coupon/batch-code-collapse-spaces'),
            'variant' => 'secondary',
        ];
        $header['actions'][] = [
            'label' => '批量生成优惠码',
