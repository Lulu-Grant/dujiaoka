...
Route::group([
    ...
    $router->post('v2/goods/create', [\App\Http\Controllers\AdminShell\GoodsActionController::class, 'store']);
    $router->get('v2/goods/{id}/edit', [\App\Http\Controllers\AdminShell\GoodsActionController::class, 'edit']);
    $router->post('v2/goods/{id}/edit', [\App\Http\Controllers\AdminShell\GoodsActionController::class, 'update']);
