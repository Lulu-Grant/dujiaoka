...
最近一轮后台壳已经连续补齐 `goods / order / pay / coupon / carmis` 多组低风险批量动作，并补强支付回调幂等、签名失败、金额校验、已完成订单重复推进和 SDK 边界安全护栏；`carmis` 线已新增只更新卡密内容片段的批量替换页，并将批量追加卡密内容后缀页纳入第一批 beta.1 收口任务，当前 PHPUnit 基线已推进到 `398 tests / 2572 assertions`。
